...
void Smtp2::sendMail(const QString &from, const QString &to, const QString &subject, const QString &body)
{
    message = "To: " + to + "\n";
...
void Smtp2::readyRead()
{
    ...
    {
        // something broke.
        QMessageBox::warning( 0, tr( "MATOS MAILER" ), tr( "Unexpected reply from Smtp2 server:\n\n" ) + response );
        state = Close;
    }
    response = "";
}
